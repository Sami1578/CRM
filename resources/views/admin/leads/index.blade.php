...
@section('content')
    @include('admin.leads.modals.create')
    @include('admin.leads.modals.changestatus')
    @include('admin.leads.modals.send-message')
                    ...
                    <div class="card-body table-responsive">
                        <div style="display: flex; flex-direction: row;">
                            <div class="form-group col-lg-3 col-md-2">
                                <label for="status">{{ __('Filter Lead Status') }}</label>
                            ...
                            <div class="form-group col-lg-3 col-md-2">
                                <div class="select-service">
                                    <label class="infoTitle">{{ __('Filter Services') }}</label>
        ...
        $(document).ready(function(){
            ...
            $(document).delegate('#lead_status_filter', 'change', function(){
                ...
                if(filterServiceId != null){
                    filterLeadStatus = "{{ route('leads.index') }}" + "?status_id=" + filterLeadStatusId + "&service_id=" + filterServiceId;
                }else{
                    filterLeadStatus = "{{ route('leads.index') }}" + "?status_id=" + filterLeadStatusId;
                }
                {{--let filterLeadStatus = "{{ route('leads.index') }}" + "?status_id=" + filterLeadStatusId;--}}
            ...
            $(document).delegate('#service_filter', 'change', function(){
                ...
                if(filterLeadStatusId != null){
                    filterService = "{{ route('leads.index') }}" + "?status_id=" + filterLeadStatusId + "&service_id=" + filterServiceId;
                }else{
                    filterService = "{{ route('leads.index') }}" + "?service_id=" + filterServiceId;
                }
            ...
            $(document).delegate('.changeStatus', 'click', function (e){
                ...
                let url = "{{ route('leads.change.status', 'id') }}";
                url = url.replace('id', id);
                // console.log(url);
            ...
            $(document).delegate('.message', 'click', function (e){
                ...
                let url = "{{ route('leadmessages.edit', 'id') }}";
                url = url.replace('id', id);
                // console.log(url);
                $.get(url, function(data){
                    if(data.code != 100){
                ...
                $.ajax({
                    ...
                    success:function (data){
                        ...
                        if(data.code != 100){
                            ...
                            $('.messages').empty();
                            let id = data.lead_id;
                            let reload_url = "{{ route('leadmessages.edit', 'id') }}";
