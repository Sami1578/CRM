...
<div class="modal fade" id="createServiceModal" tabindex="-1" role="dialog" aria-labelledby="createServiceModalTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <form name="createServiceModalForm" method="POST" action="{{ route('services.store') }}" id="create-service-form" enctype="multipart/form-data" style="width: 50%; margin:auto;">
            @csrf
