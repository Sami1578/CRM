...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.leadstages.modals.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function(){
            ...
            var table = $('#lead_stages').DataTable({
                ...
                ajax:"<?php echo e(route('leadstages.index')); ?>",
                columns:[
                    {data: 'created_at'},
                    {data: 'id'},
                    {data: 'name'},
            ...
            $('#create-leadstage-form').submit(function (e) {
                ...
                $.ajax({
                    data: $(this).serialize(),
                    url: "<?php echo e(route('leadstages.store')); ?>",
                    type: "POST",
                    dataType: 'json',
            ...
            $(document).delegate('.edit', 'click', function (){
                ...
                var url = "<?php echo e(route('leadstages.edit', 'id')); ?>";
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Sami new\Laravel Projects\cnbcrm.org\cnbcrm.org\resources\views/admin/leadstages/index.blade.php ENDPATH**/ ?>