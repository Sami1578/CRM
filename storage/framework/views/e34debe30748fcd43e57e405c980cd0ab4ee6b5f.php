...
<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('admin.services.modals.create', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('admin.services.modals.changestatus', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        $(document).ready(function(){
            ...
            $(document).delegate('.delete', 'click', function (){
                ...
                if(result){
                    $.ajax({
                        type: "DELETE",
                        url: "<?php echo e(route('services.store')); ?>"+'/'+id,
                        success: function (data) {
                            table.draw();
            ...
            $(document).delegate('.edit', 'click', function (){
                $('.errors').empty();
                var id = $(this).attr('data-id');
                var url = "<?php echo e(route('services.edit', 'id')); ?>";
            ...
            $(document).delegate('.changeStatus', 'click', function (e){
                ...
                let url = "<?php echo e(route('services.change.status', 'id')); ?>";
                url = url.replace('id', id);
                $.get(url, function(data){
                    if(data.code != 100){
            ...
            $('#change-status-form').submit(function (e){
                ...
                $.ajax({
                    data : formData,
                    url: "<?php echo e(route('services.update.status')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Sami new\Laravel Projects\cnbcrm.org\cnbcrm.org\resources\views/admin/services/index.blade.php ENDPATH**/ ?>